...
void UMHCharacterStatWidget::NativeConstruct()
{
	Super::NativeConstruct();
	
	for (TFieldIterator<FNumericProperty> PropIt(FMHCharacterStat::StaticStruct()); PropIt; ++PropIt)
	{
...
void UMHCharacterStatWidget::UpdateStat(const FMHCharacterStat& BaseStat, const FMHCharacterStat& ModifierStat)
{
	for (TFieldIterator<FNumericProperty> PropIt(FMHCharacterStat::StaticStruct()); PropIt; ++PropIt)
	{
		const FName PropKey(PropIt->GetName());
